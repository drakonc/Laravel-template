                    ...
                    {!! Form::model($role, ['method' => 'PATCH','route' => ['roles.update', $role->id]]) !!}
                        <div class="col-12 mb-4">
                            <div class="form-group row">
                                ...
                                <div class="col-12">
                                    {!! Form::text('name', null, ['id'=>'name','class' => 'form-control','placeholder'=>'Ingrese el nombre del rol','disabled'])!!}
                                            ...
                                            <div class="card mb-2">
                                                <div class="card-body">
                                                    <div class="form-check form-check-inline form-switch">
                                                        {{ Form::checkbox('permission[]', $value->id, in_array($value->id, $rolePermissions) ? true : false, ['class' => 'form-check-input',"role"=>"switch"]) }}
